    ...
    <div class="row my-2">
        ...
        <div class="col-md-3 d-flex justify-content-center">
            <a href="">
                ...
                <img src="{{ asset('storage/profile_photos/' . Auth::user()->profile_photo_path) }}" class="rounded rounded-circle" width="200" height="200" alt="">
                @else
                <img src="{{ asset('storage/profile_photos/' . Auth::user()->profile_photo_path) }}" class="rounded rounded-circle" height="200" alt="">
                @endif
        ...
        <div class="col-md-7">
            <div class="row mt-3">
                <div class="col-md-7 userProfile">
                    <div class="forShow">
                        <h5 class="mb-3"><span language='eng'>Name</span><span language="mm">အမည်</span> : {{ Auth::user()->name }}</h5>
                        <h5 class="mb-3"><span language='eng'>User Id</span><span language="mm">အိုင်ဒီ</span> : <span class="text-muted">uid-{{$user->id}}</span></h5>
                        <h5 class="mb-3"><span language='eng'>Plan End Date</span><span language="mm">အစီအစဉ်ကုန်ဆုံးရက်</span> :
                            @if(Auth::user()->plan_end_date)
                            <small>{{ date('d-m-Y | h:i:s A',strtotime(Auth::user()->plan_end_date)) }}</small>
                            @endif
                        </h5>
                        <h5 class="mb-3"><span language='eng'>Data</span><span language="mm">အချက်အလက်</span> : <span class="badge bg-primary">
                            ...
                            @if(strtotime($user->plan_end_date) < time()) <span class="ml-2 badge  bg-danger">Plan Expired</span>
                                @else
                                <span class="ml-2 badge bg-success">Plan Active</span>
                                @endif
                        </h5>
                        <h5 class="mb-3"><i class="fa-solid fa-envelope"></i> {{ Auth::user()->email }}</h5>
                        <h5 class="mb-3"><i class="fa-solid fa-circle-h"></i> {{ Auth::user()->ctypto_points }} <small class="text-muted">coins</small></h5>
                        <div>
                            <a href="" class="btn btn-outline-light w-100 my-2"><i class="fa-solid fa-arrow-rotate-right"></i> Refresh</a>
                            <button type="button" class="btn btn-primary  w-100 " id="editProfileBtn"><i class="fa-solid fa-pen-to-square"></i> Edit</button>
                            <button type="button" class="btn btn-primary w-100  my-2" id="editPassBtn"><i class="fa-solid fa-key"></i>
                    ...
                    <form class="d-none" id="upDateProfileForm" enctype="multipart/form-data">
                        ...
                        <div class="my-2">
                            ...
                            <input value="{{ Auth::user()->name }}" type="text" name="name" id="nameInput" class="form-control name" required autocomplete="off">
                        </div>
                        <!-- Email input -->
                        <div class="my-2">
                            ...
                            <input value="{{ Auth::user()->email }}" type="email" name="email" id="emailInput" class="form-control  email" required autocomplete="off">
                        </div>
                        <!-- Gender input -->
                        <div class="my-2">
                            ...
                            <select name="gender" class="form-control bg-dark gender" id="genderL">
                                ...
                                <option value="rather" @if(Auth::user()->gender == 'rather') selected @endif>Rather not to say</option>
                    ...
                    <form action="" class="d-none" id="upDatePasswordForm">
                        ...
                        <div class="my-2">
                            ...
                            <input value="" type="password" name="password" placeholder="" id="oldPassword" class="form-control" autocomplete="off">
                        </div>
                        <!--New Password input -->
                        <div class="my-2">
                            ...
                            <input value="" type="password" name="newPassword" id="password" class="form-control" autocomplete="off">
                        </div>
                        ...
                        <div>
                            ...
                            <input value="" type="password" name="newConfirmPassword" id="c_passwords" class="form-control" autocomplete="off">
                        </div>
