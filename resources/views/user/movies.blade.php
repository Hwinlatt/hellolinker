...
<div class="container-fluid">
    <div class="row">
        ...
        <div class="col-md-8 mb-5 mt-2">
            <h5 class="mt-3 text-center"><span language="eng">Enjoy Movies</span><span language="mm">ရုပ်ရှင်များကြည့်ရှုခံစားပါ</span></h5>
            ...
            <div class="linkContainer d-flex justify-content-evenly flex-wrap">
                ...
                <div class="card m-1 my-2 movieCard" style="width: 10rem;">
                    <div class=" position-relative overflow-hidden">
                        <img src="{{asset('storage/movie_photos/'.$m->image)}}" class="card-img-top" style="height: 8rem;" alt="...">
                        ...
                        <div class=" position-absolute start-50 top-50 translate-middle">
                            <a href="{{route('user#movie_info',$m->id)}}" class="fs-1 d-none text-primary shadow  movLink " id=""><i class="fa-solid fa-play"></i></a>
                        </div>
                    </div>
                    <div class="card-body">
                        <div class="text-center">
                            <a href="{{route('user#movie_info',$m->id)}}" class="text-light"><h6 class="card-title ">{{$m->name}}</h6></a>
                        </div>
                    </div>
                </div>
                @endforeach
            </div>
            <div class="mt-2">{{$movies->appends(request()->query())->links()}}</div>
        </div>
        <div class="col-md-2"></div>
    </div>
</div>
