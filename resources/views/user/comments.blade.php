        ...
        <div class="row">
            ...
            <div class="col-md-6">
                <div class="my-3">
                    ...
                    <a href="{{ route('user#movie_info', $movId) }}" class="btn btn-primary" title="Movie List"><i
                            class="fs-6 fa-solid fa-clapperboard"></i></a>
                </div>
            </div>
            <div class="row">
                <h5 class="text-center mt-5 mb-2"><i class="fa-solid fa-comments text-primary"></i> <span
                        language='eng'>Comments</span><span language='mm'>မှတ်ချက်များ</span>( {{ $comments->total() }} )
                </h5>
                                                ...
                                                <ul class="dropdown-menu" aria-labelledby="cmtAction">
                                                    <li>
                                                        <a class="dropdown-item delCmtBtn"
                                                            ...
                                                            <span language='eng'>Remove</span><span
                                                                language='mm'>ဖျက်ပြစ်ရန်</span>
                                                        </a>
                                                    </li>
                                                    {{-- <li>
            ...
            <div class="col-md-4 my-4 align-items-center">
                <form action="{{ route('user#comment_add', $movId) }}" class="commentForm" method="POST">
                    @csrf
                    <!-- Comment Input -->
                    <label class="form-label" for="form1"><span language="eng">Entert Comment</span><span
                            language="mm">မှတ်ချက်ရေးရန်</span></label>
    ...
    <script>
        ...
        $(document).ready(function() {
            ...
            $('.commentForm').submit(function(e) {
                ...
                $.ajax({
                    type: "POST",
                    url: "{{ route('user#comment_add', $movId) }}",
                    data: {
                        comment,
                        rating,
                        _token
