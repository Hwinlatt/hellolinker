        ...
        <div class="row mt-5 ">
            ...
            <div class="col-md-6 mb-4 ">
                ...
                <form class="mt-3 card p-5 shadow bg-dark" method="POST" action="{{ route('register') }}">
                    <h5 class="text-center"><span language='eng'>Register Form</span><span language='mm'>အကောင့်ဖွင့်ရန်</span></h5>
                    ...
                    <div class="form-outline mb-4">
                        <input type="password" name="password_confirmation" id="CpasswordInput" class="form-control  @error('password_confirmation') is-invalid @enderror" required
                            autocomplete="off">
                        <label class="form-label" for="CpasswordInput" style="margin-left: 0px">
                            <span language='eng'>Confirm Password</span><span language='mm'>စကား၀ှက်အတည်ပြုပါ</span>
                        </label>
                    </div>
                    <!-- Gender input -->
                    <div class="form-outline mb-4">
                        <select name="gender" id="" class=" form-select bg-dark text-light">
                            ...
                            <option value="rather" @if(old('gender') == 'rather') selected  @endif>Rather not to say</option>
                        </select>
                    </div>
