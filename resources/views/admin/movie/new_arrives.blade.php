                ...
                <div id="example2_wrapper" class="dataTables_wrapper dt-bootstrap4">
                    ...
                    <div class="row">
                        <div class="col-sm-12 overflow-auto">
                            <table id="movieTable" class="table  table-bordered table-dark table-hover dataTable dtr-inline" aria-describedby="example2_info">
                                <thead>
                                    <tr>
                                    ...
                                    <tr class="align-middle">
                                        ...
                                        <td>
                                            <div class="d-flex justify-content-evenly">
                                                <a href="{{route('admin#movie_edit',$movie->id)}}"  title="edit movie" class="btn-sm m-1  btn-primary"><i class="fa-solid fa-pen-to-square"></i></a>
                                                <a href="" title="more" class="btn-sm m-1  btn-primary"><i class="fa-solid fa-clock-rotate-left"></i></a>
                                                <a href="{{route('admin#movie_edit',$movie->id)}}?view='true'" title="more" class="btn-sm m-1  btn-primary"><i class="fa-solid fa-ellipsis"></i></a>
                                            </div>
